...
class sawyer_env(object):
    ...
    def update_velocities(self):
        ...
        clipped = self.ee_vel_to_joint_vel(self.filtered_command,raw_orientation_correction*.25)
    ...
    def setup_transforms(self):
        ...
        target_transform, _ = self.listener.lookupTransform( 'ee','target', rospy.Time(0))
    ...
    def reward_function(self):
        [dx_ArmToBlock, dy_ArmToBlock,_,_] = self.state.copy()
        ...
        reward_msg.distance1 = 0.
        reward_msg.distance2 = arm_to_block
    ...
    def step(self, _a):
        if (self.reset_test == False):
            ...
            reward, done, reward_msg = self.reward_function()
            reward -= np.sum(_a**2)*0.01
        else:
            done = True
            reward, _ , reward_msg = self.reward_function()
